...
const practiceTestQuestions = [
    { question: "The practice of managing and provisioning infrastructure through version-controlled, machine-readable definition files is known as:", options: ["Continuous Integration", "Manual Configuration", "Infrastructure as Code (IaC)", "Agile Development"], correctAnswer: "Infrastructure as Code (IaC)" },
    { question: "A tool that requires you to specify the desired end state of your infrastructure, without defining the explicit steps to get there, is using which approach?", options: ["Procedural", "Imperative", "Declarative", "Object-Oriented"], correctAnswer: "Declarative" },
    { question: "Which of the following is a popular cloud-agnostic (multi-cloud) IaC provisioning tool?", options: ["AWS CloudFormation", "Azure Resource Manager", "Terraform", "Google Cloud Deployment Manager"], correctAnswer: "Terraform" },
    { question: "In Terraform, what is the first command you should run when starting with a new or existing configuration directory?", options: ["terraform apply", "terraform plan", "terraform init", "terraform validate"], correctAnswer: "terraform init" },
    { question: "The property of an operation that ensures it can be applied multiple times without changing the result beyond the initial application is called:", options: ["Scalability", "Idempotency", "Availability", "Durability"], correctAnswer: "Idempotency" },
    { question: "The JSON or YAML files used to define a collection of AWS resources that are provisioned together are the core of which AWS service?", options: ["AWS EC2", "AWS Lambda", "AWS CloudFormation", "AWS IAM"], correctAnswer: "AWS CloudFormation" },
    { question: "Which IaC tool is primarily used for configuration management (not provisioning) and is known for its agentless, imperative approach using YAML 'playbooks'?", options: ["Terraform", "Ansible", "Packer", "Vagrant"], correctAnswer: "Ansible" },
    { question: "Terraform's configuration files are written using which language?", options: ["YAML", "JSON", "HCL (HashiCorp Configuration Language)", "Python"], correctAnswer: "HCL (HashiCorp Configuration Language)" },
    { question: "What is the primary purpose of the terraform plan command?", options: ["To immediately create the infrastructure.", "To destroy all managed infrastructure.", "To show a preview of the changes Terraform will make before you apply them.", "To initialize the backend and download providers."], correctAnswer: "To show a preview of the changes Terraform will make before you apply them." },
    { question: "When the actual, live state of your infrastructure differs from the state defined in your version-controlled code, this is known as:", options: ["A merge conflict", "A syntax error", "Configuration Drift", "A race condition"], correctAnswer: "Configuration Drift" }
];
