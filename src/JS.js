...
const practiceTestQuestions = [
    { question: "Due to hoisting, what will be logged to the console in the following code? console.log(myVar); var myVar = 10;", options: ["10", "ReferenceError", "null", "undefined"], correctAnswer: "undefined" },
    { question: "Which of the following has function-level scope rather than block-level scope?", options: ["let", "const", "var", "Both let and const"], correctAnswer: "var" },
    { question: "A JavaScript closure gives a function access to what?", options: ["The global scope only.", "The scope of the function in which it was defined.", "The scope of the function that calls it.", "The browser's window object exclusively."], correctAnswer: "The scope of the function in which it was defined." },
    { question: "When an asynchronous operation (like setTimeout) completes, where is its callback function placed before execution?", options: ["The Call Stack", "The Callback Queue (or Task Queue)", "The Heap", "The Microtask Queue"], correctAnswer: "The Callback Queue (or Task Queue)" },
    { question: "When a Promise is successfully fulfilled, which of the following methods will be executed?", options: [".then()", ".catch()", ".finally()", ".error()"], correctAnswer: ".then()" },
    { question: "What is the primary benefit of using async/await?", options: ["It makes asynchronous operations run faster.", "It allows you to write asynchronous code that looks synchronous and is easier to read.", "It is the only way to handle multiple asynchronous operations.", "It removes the need for the Event Loop."], correctAnswer: "It allows you to write asynchronous code that looks synchronous and is easier to read." },
    { question: "What is 'event bubbling' in the context of the DOM?", options: ["An event is captured from the top-most ancestor down to the target element.", "An event is triggered on the target element and then propagates up through its ancestors.", "Only the event on the specific target element is fired.", "All events of the same type fire simultaneously."], correctAnswer: "An event is triggered on the target element and then propagates up through its ancestors." },
    { question: "Which browser storage would you use if you need the data to be available even after the user closes and reopens the browser?", options: ["sessionStorage", "Cookies", "localStorage", "A JavaScript variable"], correctAnswer: "localStorage" },
    { question: "How does an arrow function (=>) determine the value of its this context?", options: ["It is determined by how the function is called.", "It is always bound to the global window object.", "It lexically inherits this from its parent scope.", "It does not have a this context."], correctAnswer: "It lexically inherits this from its parent scope." },
    { question: "What will be the result of '5' === 5?", options: ["true", "false", "undefined", "TypeError"], correctAnswer: "false" }
];
