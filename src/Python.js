...
const practiceTestQuestions = [
    ...
    { question: "The high performance of NumPy and Pandas is largely due to their core components being built in which programming language?", options: ["Java", "Python", "C", "R"], correctAnswer: "C" },
    { question: "What is the output of the following list comprehension? [x.upper() for x in 'abc']", options: ["\"ABC\"", "('A', 'B', 'C')", "['A', 'B', 'C']", "Error"], correctAnswer: "['A', 'B', 'C']" },
    { question: "In Pandas, which function is most suitable for combining two DataFrames with different columns, aligning them on a common index?", options: ["pd.concat()", "pd.merge()", "df.join()", "df.append()"], correctAnswer: "df.join()" },
    { question: "NumPy's ability to perform element-wise arithmetic operations on arrays of different but compatible shapes is called:", options: ["Vectorization", "Broadcasting", "Indexing", "Slicing"], correctAnswer: "Broadcasting" },
    { question: "Which library is considered the standard for data manipulation and analysis in Python?", options: ["NumPy", "SciPy", "Pandas", "Matplotlib"], correctAnswer: "Pandas" },
    { question: "When using a Pandas method like .sum() or .mean(), what does the axis=0 parameter typically specify?", options: ["The operation should be performed row-wise.", "The operation should be performed column-wise (down the rows).", "The operation should be performed in-place.", "The operation should ignore NaN values."], correctAnswer: "The operation should be performed column-wise (down the rows)." },
    { question: "A single column selected from a Pandas DataFrame is returned as which data structure?", options: ["A NumPy array", "A Python list", "A Series", "A DataFrame"], correctAnswer: "A Series" },
    { question: "Which of the following correctly defines a simple anonymous function that doubles its input?", options: ["def(x): return x * 2", "function x => x * 2", "lambda x: x * 2", "anon x: x * 2"], correctAnswer: "lambda x: x * 2" }
];
