...
const SUB_CATEGORY_TITLE = "Cryptography Concepts";

// The default set of flashcard questions for this topic.
const initialFlashcardQuestions = [
    { id: "crypto_1", deckId: "cryptography_concepts", title: SUB_CATEGORY_TITLE, front: "What is the difference between symmetric and asymmetric encryption?", back: "Symmetric Encryption uses a single, shared key for both encryption and decryption. It is very fast but has the challenge of securely distributing the shared key.\nAsymmetric Encryption uses a key pair: a public key for encryption and a private key for decryption. It is slower but solves the key distribution problem." },
    { id: "crypto_2", deckId: "cryptography_concepts", title: SUB_CATEGORY_TITLE, front: "How does a Public/Private key pair work in asymmetric encryption?", back: "The public key can be shared with anyone and is used to encrypt data. The corresponding private key is kept secret by the owner and is the only key that can decrypt the data encrypted with the public key. This allows anyone to send a secure message to the owner, but only the owner can read it." },
    { id: "crypto_3", deckId: "cryptography_concepts", title: SUB_CATEGORY_TITLE, front: "What is a cryptographic hash function, and what are its key properties?", back: "A hash function is a one-way mathematical function that takes an input of any size and produces a fixed-size string of characters, called a hash. Key properties are:\nDeterministic: The same input will always produce the same output.\nPre-image Resistance: It is infeasible to reverse the function (find the input from the output).\nCollision Resistance: It is infeasible to find two different inputs that produce the same output." },
    { id: "crypto_4", deckId: "cryptography_concepts", title: SUB_CATEGORY_TITLE, front: "What is a digital signature and what security services does it provide?", back: "A digital signature is a cryptographic mechanism used to verify the authenticity and integrity of a digital message. It is created by hashing the message and then encrypting the hash with the sender's private key. It provides:\nAuthentication: Verifies the sender's identity.\nIntegrity: Ensures the message has not been altered.\nNon-repudiation: The sender cannot deny having sent the message." },
    { id: "crypto_5", deckId: "cryptography_concepts", title: SUB_CATEGORY_TITLE, front: "What is the role of a Certificate Authority (CA)?", back: "A Certificate Authority (CA) is a trusted third-party entity that issues digital certificates. The CA verifies the identity of an entity (like a website or organization) and then signs their public key with its own private key, creating a certificate. This allows others to trust that a given public key truly belongs to that entity." },
    { id: "crypto_6", deckId: "cryptography_concepts", title: SUB_CATEGORY_TITLE, front: "What is 'salting' in the context of password hashing?", back: "Salting is the process of adding a unique, random string of characters (the 'salt') to each user's password before it is hashed. The salt is then stored along with the hash. This ensures that even if two users have the same password, their stored hashes will be different, which protects against attacks like rainbow tables." },
    { id: "crypto_7", deckId: "cryptography_concepts", title: SUB_CATEGORY_TITLE, front: "Name one common symmetric encryption algorithm and one asymmetric one.", back: "Symmetric: AES (Advanced Encryption Standard) is the most widely used standard.\nAsymmetric: RSA (Rivest–Shamir–Adleman) is one of the most common algorithms." },
    { id: "crypto_8", deckId: "cryptography_concepts", title: SUB_CATEGORY_TITLE, front: "What is the 'key distribution problem'?", back: "The key distribution problem is the challenge of securely sharing a secret key between two parties so they can communicate using symmetric encryption, without an eavesdropper being able to intercept the key. Asymmetric cryptography was invented primarily to solve this problem." },
    { id: "crypto_9", deckId: "cryptography_concepts", title: SUB_CATEGORY_TITLE, front: "What is a digital certificate?", back: "A digital certificate is an electronic document used to prove the ownership of a public key. It contains the public key, information about the owner (like a domain name), and a digital signature from a Certificate Authority (CA). Browsers use these certificates to verify the identity of a website and establish a secure HTTPS connection." },
    { id: "crypto_10", deckId: "cryptography_concepts", title: SUB_CATEGORY_TITLE, front: "What does 'non-repudiation' mean?", back: "Non-repudiation is a security service that provides proof of the origin and integrity of data. In practice, it means that a party cannot deny having sent a message or performed an action. Digital signatures are a key tool for achieving non-repudiation." }
];

// The questions for the multiple-choice practice test.
const practiceTestQuestions = [
    { question: "The AES (Advanced Encryption Standard) algorithm is a widely used example of which type of encryption?", options: ["Asymmetric", "Symmetric", "Hashing", "Steganography"], correctAnswer: "Symmetric" },
    { question: "In asymmetric cryptography, the public key is used for _____, while the private key is used for _____.", options: ["decryption, encryption", "creating signatures, verifying signatures", "encryption, decryption", "decryption, creating signatures"], correctAnswer: "encryption, decryption" },
    { question: "A one-way function that takes an input of any size and produces a fixed-size output is called a:", options: ["Symmetric cipher", "Asymmetric cipher", "Cryptographic hash function", "Digital signature"], correctAnswer: "Cryptographic hash function" },
    { question: "To ensure data integrity and verify that a downloaded file has not been altered in transit, which cryptographic tool would you use?", options: ["Symmetric encryption", "A hash function", "Asymmetric encryption", "A digital certificate"], correctAnswer: "A hash function" },
    { question: "The RSA algorithm is a foundational and widely used example of which type of encryption?", options: ["Hash-based", "Symmetric", "Asymmetric", "Stream cipher"], correctAnswer: "Asymmetric" },
    { question: "What is the primary purpose of adding a 'salt' to a password before hashing it?", options: ["To make the hash shorter.", "To make the password easier to remember.", "To make the hashing process reversible.", "To prevent pre-computed hash attacks (like rainbow tables)."], correctAnswer: "To prevent pre-computed hash attacks (like rainbow tables)." },
    { question: "A digital signature is created by encrypting a hash of the message with the sender's:", options: ["Public Key", "Private Key", "Symmetric Key", "Session Key"], correctAnswer: "Private Key" },
    { question: "Which of the following is NOT a fundamental property of a secure hash function?", options: ["Collision Resistance", "Pre-image Resistance", "Determinism", "Reversibility"], correctAnswer: "Reversibility" },
    { question: "If Alice wants to send a securely encrypted message to Bob using asymmetric cryptography, which key should she use to encrypt the message?", options: ["Alice's private key", "Alice's public key", "Bob's private key", "Bob's public key"], correctAnswer: "Bob's public key" },
    { question: "In the Public Key Infrastructure (PKI) model, the entity responsible for issuing and vouching for the authenticity of digital certificates is the:", options: ["Registration Authority (RA)", "Certificate Authority (CA)", "End User", "Domain Registrar"], correctAnswer: "Certificate Authority (CA)" }
];
