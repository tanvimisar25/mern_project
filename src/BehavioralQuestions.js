...
const initialFlashcardQuestions = [
    ...
    { id: "bq_3", deckId: "behave", title: SUB_CATEGORY_TITLE, front: "Give an example of when you went above and beyond at work.", back: " During a product release, I volunteered extra hours to automate repetitive testing tasks. This reduced QA time by 30% and ensured a smoother release." },
    { id: "bq_4", deckId: "behave", title: SUB_CATEGORY_TITLE, front: "Tell me about a time you failed at something. How did you recover?", back: "I once underestimated the time needed for integration testing. I took accountability, informed my manager early, and worked with the QA team to create a new testing checklist that prevented similar delays." },
    { id: "bq_5", deckId: "behave", title: SUB_CATEGORY_TITLE, front: "Describe a time you worked with a difficult client", back: " A client was unhappy with constant delays. I maintained transparency, provided frequent progress updates, and managed expectations, which helped rebuild trust." },
    { id: "bq_6", deckId: "behave", title: SUB_CATEGORY_TITLE, front: "Share an instance where you had to quickly learn a new skill for a project.", back: "I had to pick up React within a week for a feature requirement. I used online tutorials, practiced small projects, and collaborated with a senior developer, which enabled me to contribute effectively" },
    { id: "bq_7", deckId: "behave", title: SUB_CATEGORY_TITLE, front: " Tell me about a time you showed leadership without being in a formal role.", back: "In a group project, I took initiative to divide responsibilities, kept track of progress, and motivated the team. This improved coordination and we completed the task successfully." },
    { id: "bq_8", deckId: "behave", title: SUB_CATEGORY_TITLE, front: "Describe a situation where you improved a process at work.", back: " I noticed manual deployment caused frequent errors, so I introduced CI/CD pipelines. This reduced deployment time and minimized production issues." },
    { id: "bq_9", deckId: "behave", title: SUB_CATEGORY_TITLE, front: "Give an example of a goal you set and how you achieved it.", back: " I aimed to improve my coding speed. I practiced solving 2-3 coding problems daily and reviewed optimized solutions, which significantly improved my efficiency in real projects." },
...
const practiceTestQuestions = [
    ...
    { question: "What is the main purpose of behavioral interview questions?", options: ["To test your technical coding ability.", "To understand how you behaved in past situations as a predictor of future performance.", "To check your general knowledge.", "To evaluate your typing speed."], correctAnswer: "To understand how you behaved in past situations as a predictor of future performance." },
    { question: "When answering 'Tell me about a failure,' the best approach is to:", options: ["Say you never failed.", "Share a real failure, take responsibility, and explain what you learned.", "Blame teammates or external factors.", "Describe a minor failure but hide the outcome."], correctAnswer: "Share a real failure, take responsibility, and explain what you learned." },
    { question: "Which of the following is MOST effective when asked about teamwork?", options: ["Talking about working completely alone.", "Giving an example of successful collaboration and your role in it.", "Saying you prefer not to work in teams.", "Avoiding specifics and giving generic statements."], correctAnswer: "Giving an example of successful collaboration and your role in it." },
    { question: "Why do interviewers ask about handling difficult clients or managers?", options: ["To see if you gossip about others.", "To assess your communication, patience, and conflict resolution skills.", "To test your memory of incidents.", "To know if you’ll refuse to work with difficult people."], correctAnswer: "To assess your communication, patience, and conflict resolution skills." },
    { question: "Which type of example works best in behavioral answers?", options: ["Hypothetical examples.", "Real-life examples from past work, internships, or projects.", "Examples unrelated to work, like personal life only.", "Made-up stories to impress."], correctAnswer: "Real-life examples from past work, internships, or projects." },
    { question: "When asked about a leadership experience, you should:", options: ["Highlight how you directed the team, solved problems, and the outcome.", "Only talk about technical contributions.", "Say you’ve never led and skip the question.", "Criticize teammates’ performance."], correctAnswer: "Highlight how you directed the team, solved problems, and the outcome." },
    { question: "What should you emphasize when discussing working under pressure?", options: ["That you panic but somehow manage.", "Strategies you use to stay calm, organized, and productive.", "That you avoid such situations.", "That you don’t like deadlines."], correctAnswer: "Strategies you use to stay calm, organized, and productive." },
    { question: "How can you make your behavioral answers most impressive?", options: ["By using the STAR method and backing answers with measurable results.", "By memorizing scripted answers without flexibility.", "By keeping answers extremely short without detail.", "By focusing only on your technical knowledge."], correctAnswer: "By using the STAR method and backing answers with measurable results." }
];
