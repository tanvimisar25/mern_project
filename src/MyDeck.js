...
// ✅ Corrected Add Icon to accept and apply a className
...
// ✅ Corrected Trash Icon to accept and apply a className
    ...
    return (
        <div className="todo-list-card">
            ...
            <form onSubmit={handleAddTodo} className="todo-form">
                ...
                />
                {/* ✅ Passing className to the icon component */}
...
// ✅ Renamed class to MyDeck to match export
