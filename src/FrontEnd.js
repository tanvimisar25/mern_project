...
const initialFlashcardQuestions = [
    { id: "fe_1", deckId: "frontend_frameworks", front: "What is the Virtual DOM?", back: "The Virtual DOM (VDOM) is a concept where a virtual copy of the UI is kept in memory and synced with the real DOM. When a component’s state changes, the new VDOM is compared with the old one ('diffing'), and only the necessary updates are applied to the real DOM, making it faster." },
