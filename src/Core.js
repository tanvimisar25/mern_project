...
// An array of objects representing the different subcategories within Core Interview Questions.
...
// The main component for the Core Interview Questions category page.
const Core = () => {
