...
// --- (SVG Icon Components) ---
// A collection of reusable SVG icon components for the sidebar navigation.
...
const CybersecurityIcon = () => ( <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.286zm0 13.036h.008v.008h-.008v-.008z" /></svg> );

/**
 * A simple component to display the application's logo with a hover animation.
 */
function Logo() {
  return (
...
/**
 * The main layout component for the application. It includes the collapsible sidebar
 * and an <Outlet> where nested routes will be rendered.
 */
export default function SidebarLayout() {
  // State to track if the sidebar is being hovered, which controls CSS classes.
  const [isSidebarHovered, setIsSidebarHovered] = useState(false);
  // Hooks for accessing authentication context and navigation.
  ...
  return (
    <div className="layout-wrapper">
      ...
      <div className="layout">
          ...
          <div className="sidebar-content">
            <div className="sidebar-section">
              ...
              <ul className="sidebar-menu">
                <li>
                  {/* The Home link points to the dashboard for logged-in users, otherwise to the public homepage. */}
            ...
            <div className="sidebar-section">
              ...
              <ul className="sidebar-menu">
                <li><Link to="/core" className="sidebar-link"><CoreSkillsIcon /><span className="link-text">Core Interview Skills</span></Link></li>
                <li><Link to="/dsa" className="sidebar-link"><DSAIcon /><span className="link-text">DSA</span></Link></li>
                <li><Link to="/webdev" className="sidebar-link"><WebDevIcon /><span className="link-text">Web Development</span></Link></li>
                <li><Link to="/datascience" className="sidebar-link"><DataScienceIcon /><span className="link-text">Data Science and AI</span></Link></li>
                <li><Link to="/cloudcomputing" className="sidebar-link"><CloudDevOpsIcon /><span className="link-text">Cloud and DevOps</span></Link></li>
                <li><Link to="/cybersecurity" className="sidebar-link"><CybersecurityIcon /><span className="link-text">Cybersecurity</span></Link></li>
              </ul>
            </div>
          </div>

          {/* Sidebar footer with conditional Login/Logout link. */}
        ...
        {/* This is the main content area where child routes will be rendered. */}
